-- Upload player data for Madden League Alpha - Simple version
-- Run this in your Supabase SQL Editor

-- Insert player data with proper JSON formatting
INSERT INTO json_uploads (user_id, payload, uploaded_at) 
SELECT 
